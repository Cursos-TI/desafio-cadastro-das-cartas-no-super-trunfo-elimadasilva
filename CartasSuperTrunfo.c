...
int main(){
    ...
    densidadePopulacionalCidade1, densidadePopulacionalCidade2, inversoDensidadePopulacionalCidade1,
    inversoDensidadePopulacionalCidade2, PIBperCapita1, PIBperCapita2, superPoderCarta1, superPoderCarta2;
